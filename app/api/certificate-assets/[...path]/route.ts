...
// Serves a certificate template's logo. Deliberately unauthenticated,
// same reasoning and same safeguards as app/api/website-assets — a
// school logo isn't sensitive, and the path itself (random UUID
// filenames under a per-school subdir) is validated strictly here to
// rule out path traversal or serving anything outside that subdir.
const SAFE_PATH = /^certificates\/[a-z0-9-]+\/[A-Za-z0-9._-]+$/;
