...
// Serves vehicle document-repository files (insurance policy, RC, permit,
// pollution cert). Same shape as person-documents: authenticated session
// required, and it must belong to the exact school the path segment names.
const SAFE_PATH = /^vehicle-documents\/([a-z0-9-]+)\/[A-Za-z0-9._-]+$/;
